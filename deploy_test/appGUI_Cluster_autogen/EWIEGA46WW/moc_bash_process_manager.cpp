...
namespace {
struct qt_meta_tag_ZN20Bash_Process_ManagerE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN20Bash_Process_ManagerE = QtMocHelpers::stringData(
...
Q_CONSTINIT static const uint qt_meta_data_ZN20Bash_Process_ManagerE[] = {
...
Q_CONSTINIT const QMetaObject Bash_Process_Manager::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN20Bash_Process_ManagerE.offsetsAndSizes,
    qt_meta_data_ZN20Bash_Process_ManagerE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN20Bash_Process_ManagerE_t,
        // Q_OBJECT / Q_GADGET
...
void Bash_Process_Manager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->slotEndTime((*reinterpret_cast< std::add_pointer_t<QDateTime>>(_a[1]))); break;
        case 3: _t->handleOutput(); break;
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (Bash_Process_Manager::*)(const int );
            if (_q_method_type _q_method = &Bash_Process_Manager::slurmIdReady; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _q_method_type = void (Bash_Process_Manager::*)(QString );
            if (_q_method_type _q_method = &Bash_Process_Manager::slurm_status_changed; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            using _q_method_type = void (Bash_Process_Manager::*)(QDateTime );
            if (_q_method_type _q_method = &Bash_Process_Manager::slotEndTime; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
...
void *Bash_Process_Manager::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN20Bash_Process_ManagerE.stringdata0))
...
// SIGNAL 2
void Bash_Process_Manager::slotEndTime(QDateTime _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
