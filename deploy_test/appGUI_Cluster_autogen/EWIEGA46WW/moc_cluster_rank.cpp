...
namespace {
struct qt_meta_tag_ZN12Cluster_RankE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN12Cluster_RankE = QtMocHelpers::stringData(
    "Cluster_Rank",
    "QML.Element",
    "auto",
...
Q_CONSTINIT static const uint qt_meta_data_ZN12Cluster_RankE[] = {
...
Q_CONSTINIT const QMetaObject Cluster_Rank::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN12Cluster_RankE.offsetsAndSizes,
    qt_meta_data_ZN12Cluster_RankE,
    qt_static_metacall,
    nullptr,
    qt_metaTypeArray<
...
void Cluster_Rank::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (Cluster_Rank::*)();
            if (_q_method_type _q_method = &Cluster_Rank::send_p2p_datasizeChanged; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _q_method_type = void (Cluster_Rank::*)();
            if (_q_method_type _q_method = &Cluster_Rank::recv_p2p_datasizeChanged; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            using _q_method_type = void (Cluster_Rank::*)();
            if (_q_method_type _q_method = &Cluster_Rank::send_coll_datasizeChanged; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
        {
            using _q_method_type = void (Cluster_Rank::*)();
            if (_q_method_type _q_method = &Cluster_Rank::recv_coll_datasizeChanged; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 3;
                return;
            }
        }
        {
            using _q_method_type = void (Cluster_Rank::*)();
            if (_q_method_type _q_method = &Cluster_Rank::p2p_late_senderChanged; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 4;
                return;
            }
        }
        {
            using _q_method_type = void (Cluster_Rank::*)();
            if (_q_method_type _q_method = &Cluster_Rank::p2p_late_recvrChanged; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 5;
                return;
            }
        }
        {
            using _q_method_type = void (Cluster_Rank::*)();
            if (_q_method_type _q_method = &Cluster_Rank::p2p_timediffChanged; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 6;
                return;
            }
        }
        {
            using _q_method_type = void (Cluster_Rank::*)();
            if (_q_method_type _q_method = &Cluster_Rank::coll_late_senderChanged; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 7;
                return;
            }
        }
        {
            using _q_method_type = void (Cluster_Rank::*)();
            if (_q_method_type _q_method = &Cluster_Rank::coll_late_recvrChanged; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 8;
                return;
            }
        }
        {
            using _q_method_type = void (Cluster_Rank::*)();
            if (_q_method_type _q_method = &Cluster_Rank::coll_timediffChanged; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 9;
                return;
            }
        }
        {
            using _q_method_type = void (Cluster_Rank::*)();
            if (_q_method_type _q_method = &Cluster_Rank::positionChanged; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 10;
                return;
            }
        }
...
void *Cluster_Rank::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN12Cluster_RankE.stringdata0))
