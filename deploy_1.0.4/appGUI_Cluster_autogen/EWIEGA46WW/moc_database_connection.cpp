...
namespace {
struct qt_meta_tag_ZN19Database_ConnectionE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN19Database_ConnectionE = QtMocHelpers::stringData(
    "Database_Connection"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN19Database_ConnectionE[] = {
...
Q_CONSTINIT const QMetaObject Database_Connection::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN19Database_ConnectionE.offsetsAndSizes,
    qt_meta_data_ZN19Database_ConnectionE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN19Database_ConnectionE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<Database_Connection, std::true_type>
    >,
    nullptr
} };
...
void *Database_Connection::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN19Database_ConnectionE.stringdata0))
