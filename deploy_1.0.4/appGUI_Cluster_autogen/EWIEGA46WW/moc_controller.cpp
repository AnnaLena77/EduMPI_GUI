...
Q_CONSTINIT static const uint qt_meta_data_ZN10ControllerE[] = {
 ...
 // signals: name, argc, parameters, tag, flags, initial metatype offsets
       3,    0,  220,    4, 0x106,    4 /* Public | MethodIsConst  */,
       5,    1,  221,    4, 0x06,    5 /* Public */,
       7,    1,  224,    4, 0x06,    7 /* Public */,
       9,    1,  227,    4, 0x06,    9 /* Public */,
      11,    1,  230,    4, 0x06,   11 /* Public */,
      13,    1,  233,    4, 0x06,   13 /* Public */,
      15,    1,  236,    4, 0x06,   15 /* Public */,
      17,    5,  239,    4, 0x06,   17 /* Public */,
      18,    1,  250,    4, 0x06,   23 /* Public */,
      20,    0,  253,    4, 0x06,   25 /* Public */,
      21,    1,  254,    4, 0x06,   26 /* Public */,
      23,    0,  257,    4, 0x06,   28 /* Public */,
      24,    0,  258,    4, 0x06,   29 /* Public */,

 // slots: name, argc, parameters, tag, flags, initial metatype offsets
      25,    1,  259,    4, 0x0a,   30 /* Public */,
      26,    1,  262,    4, 0x0a,   32 /* Public */,
      27,    1,  265,    4, 0x0a,   34 /* Public */,
      29,    0,  268,    4, 0x0a,   36 /* Public */,

 // methods: name, argc, parameters, tag, flags, initial metatype offsets
      30,    5,  269,    4, 0x02,   37 /* Public */,
      36,    3,  280,    4, 0x02,   43 /* Public */,
      39,    0,  287,    4, 0x02,   47 /* Public */,
      40,    0,  288,    4, 0x02,   48 /* Public */,
      41,    1,  289,    4, 0x02,   49 /* Public */,
      42,    0,  292,    4, 0x02,   51 /* Public */,
      43,    1,  293,    4, 0x02,   52 /* Public */,
      45,    3,  296,    4, 0x02,   54 /* Public */,
      48,    3,  303,    4, 0x02,   58 /* Public */,
      51,    3,  310,    4, 0x02,   62 /* Public */,
      55,    4,  317,    4, 0x02,   66 /* Public */,
      58,    0,  326,    4, 0x02,   71 /* Public */,
      59,    1,  327,    4, 0x02,   72 /* Public */,
      61,    1,  330,    4, 0x02,   74 /* Public */,
      62,    0,  333,    4, 0x02,   76 /* Public */,
      64,    0,  334,    4, 0x02,   77 /* Public */,
      65,    0,  335,    4, 0x02,   78 /* Public */,
 ...
 // properties: name, type, flags, notifyId, revision
      ...
      66, QMetaType::Bool, 0x00015003, uint(11), 0,
      67, QMetaType::Bool, 0x00015003, uint(12), 0,
...
void Controller::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 32: { QString _r = _t->getClusterIdent();
            if (_a[0]) *reinterpret_cast< QString*>(_a[0]) = std::move(_r); }  break;
        case 33: { bool _r = _t->copyEnvFile();
            if (_a[0]) *reinterpret_cast< bool*>(_a[0]) = std::move(_r); }  break;
        default: ;
        }
    }
