...
namespace {
struct qt_meta_tag_ZN12Cluster_NodeE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN12Cluster_NodeE = QtMocHelpers::stringData(
    "Cluster_Node",
    "QML.Element",
    "auto",
    "ranksChanged",
...
Q_CONSTINIT static const uint qt_meta_data_ZN12Cluster_NodeE[] = {
...
Q_CONSTINIT const QMetaObject Cluster_Node::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN12Cluster_NodeE.offsetsAndSizes,
    qt_meta_data_ZN12Cluster_NodeE,
    qt_static_metacall,
    nullptr,
    qt_metaTypeArray<
        // property 'count'
...
void Cluster_Node::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (Cluster_Node::*)();
            if (_q_method_type _q_method = &Cluster_Node::ranksChanged; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _q_method_type = void (Cluster_Node::*)();
            if (_q_method_type _q_method = &Cluster_Node::timestampsChanged; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
void *Cluster_Node::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN12Cluster_NodeE.stringdata0))
