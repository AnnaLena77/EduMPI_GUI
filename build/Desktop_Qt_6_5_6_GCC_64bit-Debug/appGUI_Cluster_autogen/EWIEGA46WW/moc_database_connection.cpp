...
constexpr auto qt_meta_stringdata_CLASSDatabase_ConnectionENDCLASS = QtMocHelpers::stringData(
    "Database_Connection"
);
...
Q_CONSTINIT const QMetaObject Database_Connection::staticMetaObject = { {
    ...
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSDatabase_ConnectionENDCLASS_t,
        // Q_OBJECT / Q_GADGET
